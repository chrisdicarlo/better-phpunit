...
module.exports = class ArtisanTestCommand {
    constructor(options) {
    ...
    get binary() {
        if (vscode.workspace.getConfiguration('better-phpunit').get('localEnv')) {
          return 'php artisan test' + '--env=' + vscode.workspace.getConfiguration('better-phpunit').get('localEnv')
        }
    }
